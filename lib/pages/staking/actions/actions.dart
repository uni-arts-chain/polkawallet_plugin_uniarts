...
class _StakingActions extends State<StakingActions> {
      ...
      return Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: i.success
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_uniarts/assets/images/staking/ok.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_uniarts/assets/images/staking/error.svg'),
          ),
          title: Text(i.call),
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: SvgPicture.asset(
                'packages/polkawallet_plugin_uniarts/assets/images/staking/${isReward ? 'reward' : 'slash'}.svg'),
          ),
  ...
  Widget _buildActionCard() {
    var dic = I18n.of(context).getDic(i18n_full_dic_uniarts, 'staking');
  ...
  Widget build(BuildContext context) {
    final Map<String, String> dic =
        I18n.of(context).getDic(i18n_full_dic_uniarts, 'staking');
...
class RowAccount02 extends StatelessWidget {
  ...
  void _showActions(BuildContext context) {
    final dic = I18n.of(context).getDic(i18n_full_dic_uniarts, 'staking');
...
class StakingInfoPanel extends StatelessWidget {
  ...
  void _showUnlocking(BuildContext context) {
    final dic = I18n.of(context).getDic(i18n_full_dic_uniarts, 'staking');
    final dicGov = I18n.of(context).getDic(i18n_full_dic_uniarts, 'gov');
      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        cancelButton: CupertinoActionSheetAction(
          child: Text(I18n.of(context)
              .getDic(i18n_full_dic_uniarts, 'common')['cancel']),
          onPressed: () {
            Navigator.pop(context);
          },
        ),
